...
- On recovery (re-apply the Listeners): MM2 drains lag, cloud processor reconnects and commits backlog
...
**What to actually expect on cloud during "Interconnect Broken" — confirmed live, six findings:**
