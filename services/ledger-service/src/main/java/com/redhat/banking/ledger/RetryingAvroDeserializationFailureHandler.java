...
// with a permanently dead Kafka consumer — confirmed live, ~40 minutes of zero
// consumption on transactions-committed until manually restarted, triggered by one
// transient "apicurio-registry...: Name or service not known" DNS blip through RHSI.
//
// This registers as mp.messaging.incoming.committed-in.value-deserialization-failure-handler
